module "db" {
  ...
  #Include snapshot ID once the creation of the Database has occured.
  #For initial creation of database do not include snapshot id
  #snapshot_identifier = var.snapshotid
  ...
  vpc_security_group_ids = [aws_security_group.theladsDB.id]
